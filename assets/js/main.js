...
sr.reveal('.gallery-image1', {origin: 'left'})
sr.reveal('.gallery-image2', {origin: 'right'})
sr.reveal('.gallery-image3', {origin: 'top'})
sr.reveal('.gallery-image4', {origin: 'bottom'})
sr.reveal('.gallery-image5', {origin: 'right'})